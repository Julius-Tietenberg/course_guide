...
function Start () {
  ...
  return (
    <Box sx={{ minHeight: '48rem', width: '100%', backgroundColor: "white", backgroundImage: 'linear-gradient(179deg, #FFFFFF 0%, #95d5b2 25%, #52b788 50%, #2d6a4f 75%, #174731 100%)' }} minWidth="ms" >
      <CssBaseline />
      {/* tab bar */}
      ...
      <TabPanel value={tabValue} index={0}>
        <Box sx={{ display: 'flex', alignItems: 'center', m: '0 10%', mr: '10%', mt:"4%"}}>
          <Container>
