...
function RatingForm (props) {
  ...
  const [workloadValue, setWorkloadValue] = React.useState(5)
  const [difficultyValue, setDifficultyValue] = React.useState(5)


  let average = (teachingValue + learningValue + workloadValue + difficultyValue) / 4
    ...
    <Box >
      ...
      <DialogContent>
        <Stack spacing={1} sx={{ ml: "20px" }}>
          ...
          <RatingBar name="Workload" value={workloadValue} setValue={setWorkloadValue} />
